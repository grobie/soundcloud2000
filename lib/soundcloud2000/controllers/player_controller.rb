    ...
    class PlayerController < Controller
      ...
      def play(track)
        unless track == nil
          ...
          UI::Input.input_line_out("No track currently selected. Use f to switch to #{@client.current_user.username}'s favorites, or s to switch to their playlists/sets.")
        end
      end
